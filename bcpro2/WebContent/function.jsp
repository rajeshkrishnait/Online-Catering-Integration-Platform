    ...
    <div class="header pb-8 pt-5 pt-lg-8 d-flex align-items-center" style="min-height: 630px; background-image: url(https://wallpapercave.com/wp/wp3108352.jpg); background-size: cover; background-position: center top;">
      ...
      <span class="mask bg-gradient-default opacity-8"></span>
          ...
          <div class="card bg-dark shadow">
            ...
            <div class="card-body">
              <h1 class="display-4 text-xs-center m-y-3 text-muted" id="speakers">Search Results for "<%=searchfor%>"</h1>
...
<% if(al.size()!=0)
	{
		for(int i=0;i<al.size();i=i+12)
		{    
		%>
 
<div class="row">
  <div class="col-lg-3">
    <div class="card"><img alt="Card image cap" class="card-img-top img-fluid"  src="<%=al.get(i+10) %>" >
          </div>
  </div>
  <div class="col-lg-6">
        <h4 class="card-title" ><%=al.get(i+1) %>&nbsp;&nbsp;&nbsp;&nbsp;<%=al.get(i+2)%> </h4>
        <p class="card-text" name="mobile_no">contact us at:<%=al.get(i+4)%></p>
   		<p class="card-text"><%=al.get(i+11)%> </p>
   		    
   		
  </div>   
  <div class="col-lg-3">
  <form action="passtocart" method="GET"><input type="submit" value="Visit profile" class="btn btn-primary"></input><input type="hidden" name="company_id" value="<%=al.get(i) %>"></input>  </form>
  </div>
</div>
