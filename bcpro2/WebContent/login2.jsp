...
.frame {
    height: 575px;
    width: 430px;
    background: linear-gradient(rgba(0, 0, 0, 0.75), rgba(13, 12, 16, 0.85)), url("E://Downloads/Partials/Test/background2.jfif") no-repeat center center;
...
.refreshicon:hover {
    ...
    <div class="frame">
        ...
        <div ng-app ng-init="checked = false">
            <form class="form-signin" action="companylog" method="GET" name="form"> <label for="username">Email Id</label> <input class="form-styling" type="text" name="mail_id" placeholder="" /> <label for="password">Password</label> <input class="form-styling" type="password" name="password" placeholder="" /> <input type="checkbox" id="checkbox" /> <label for="checkbox"><span class="ui"></span>Keep me signed in</label>
               <div class="form-group">
	                        <input type="submit" class="btn btn-primary" value="                                 Sign In                                      " >
	                        </input>
	                      </div>
            </form>
            <form class="form-signup" action="displayprof7" method="GET" name="form">
             
            	<label for="fullname">Company Name</label> <input class="form-styling" id="username" type="text" name="fullnam" placeholder="name" />
            	<label for="email">Email</label> <input class="form-styling" type="text" id="email" name="emai" placeholder="" /> 

            	 <label for="mobileNumber">Mobile Number</label> <input class="form-styling" type="int" id="mobileNumber" name="mobileNumbe" placeholder="" />
            	 <label for="address">Address</label> <input class="form-styling" type="text" id="address" name="addres" placeholder="" />
            	 <label for="city">City</label> <input class="form-styling" type="text" id="city" name="cit" placeholder="" />
            	 <label for="pincode">Pincode</label> <input class="form-styling" type="text" id="pincode" name="pincod" placeholder="" />
            	 <label for="state">State</label> <input class="form-styling" type="text" id="state" name="stat" placeholder="" />
            	 <label for="country">Country</label> <input class="form-styling" type="text" id="country" name="countr" placeholder="" />
            	 <label for="password">Password</label> <input class="form-styling" type="password" id="password" name="passwor"  /> 
            	 <label for="password">ReEnter Password</label> <input class="form-styling" type="password" id="password2" name="passwor"  /> 
