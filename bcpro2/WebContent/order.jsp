...
<% 
     ...
     String sql = "select * from cater_orders where user_id='"+Integer.parseInt((String)ses.getAttribute("user_id"))+"'";   
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    ...
    <!-- Header -->
    <div class="header pb-8 pt-5 pt-lg-8 d-flex align-items-center" style="min-height: 630px; background-image: url(https://wallpapercave.com/wp/wp3108352.jpg); background-size: cover; background-position: center top;">
      <!-- Mask -->
    ...
    while(rs.next())
    	{%>
    	<form action="passtoshoworder" method="GET">
    <div class="card" id="dash">
        <div class="row d-flex justify-content-between px-3 top">
            <div class="d-flex flex-column text-sm-left">
                <h5>ORDER <span class="text-primary font-weight-bold">OrdeID=<%=rs.getString(3)%></span></h5>
                <h4>Total Price:<%=rs.getString(4) %></h4>
                </div>
            <div class="d-flex flex-column text-sm-right">
                <p class="mb-0">Expected Arrival <span><%=date%></span></p>
                <p>USPS <span class="font-weight-bold">Workers Assigned:<%=rs.getString(6) %></span></p>
            </div>
        </div>
         <!-- Add class 'active' to progress -->
         <%if(rs.getString(5).equals("Order Processed"))
        		 {
        		 %>
       ...
       <%  }%>
       <%if(rs.getString(5).equals("Order Shipped"))
        		 {
        		 %>
        <div class="row d-flex justify-content-center">
            <div class="col-12">
       ...
       <%  }%>
       <%if(rs.getString(5).equals("Order En Route"))
        		 {
        		 %>
        <div class="row d-flex justify-content-center">
            <div class="col-12">
                <ul id="progressbar" class="text-center">
                    <li class="active step0"></li>
                    <li class="active step0"></li>
                    <li class="activestep0"></li>
                    <li class="step0"></li>
                </ul>
            </div>
        </div>
       <%  }%>
       <%if(rs.getString(5).equals("Order Arrived"))
        		 {
        		 %>
        <div class="row d-flex justify-content-center">
            <div class="col-12">
       ...
       <%  }%>
        <div class="row justify-content-between top">
            ...
            <div class="row d-flex icon-content"> <img class="icon" src="https://i.imgur.com/HdsziHP.png">
                ...
                <input type="hidden" name="cart_id" value="<%= rs.getString(7)%>"/>
